      ...
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-0.5">
          <button
            ...
            className="interactive-focus rounded-md px-2 py-1 text-[12px] font-medium text-muted transition-colors hover:bg-ink/[0.04] hover:text-ink"
          >
            Today
          </button>
          <button
      ...
      <div className="grid grid-cols-7 text-center">
        {DAY_INITIALS.map((d, i) => (
          <span
            key={i}
            aria-hidden
            className="pb-1.5 text-[10px] font-medium uppercase tracking-[0.04em] text-muted/80"
          >
            {d}
          </span>
        ))}
