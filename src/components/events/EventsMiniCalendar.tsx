...
// instead of a row of competing dots. Empty days get no wash and fade to
// faint, so "nothing on" reads at a glance too.
              ...
              <button
                ...
                className={[
                  ...
                  isSelected
                    ? "bg-ink text-canvas"
                    : inMonth
                      ? `${dayText} ${heat ? `${heat} hover:bg-highlander/[0.28]` : "hover:bg-ink/[0.04]"}`
