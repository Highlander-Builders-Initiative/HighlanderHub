...
export const EVENT_DETAIL_ASIDE_CLASS =
  "order-2 space-y-6 md:order-1 md:sticky md:top-24 md:self-start";
export const EVENT_DETAIL_FLYER_FRAME_CLASS =
  "relative mx-auto w-full max-w-[18rem] overflow-hidden rounded-xl border border-ink/10 bg-surface shadow-card md:mx-0 md:max-w-none";
